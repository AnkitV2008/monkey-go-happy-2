...
function draw(){
  ...
  fill("black");
  textFont("Agency FB")
  text("SURVIVAL TIME: "+score, 30, 20);
  text("BANANAS COLLECTED: "+bananaScore,160,20);
  ...
  if (gameState === PLAY){
    ...
    ground.velocityX = -(4+score*3.5/100);
...
function obstacles(){
  if (frameCount%100 === 0){
    ...
    obstacle.scale = 0.13 ;
    obstacle.velocityX = -(4+score*2.5/100);
